...
export default async function DashboardPage() {
  ...
  const [recordingCount, noteCount, actionItemCount] = await Promise.all([
    ...
    orgId
      ...
      : 0,
    orgId
      ? db.actionItem.count({ where: { orgId, status: 'OPEN' } })
      : 0,
  ])
    ...
    <div className="p-8">
      ...
      <div className="mt-8">
        ...
        {recentRecordings.length === 0 ? (
          <div className="mt-4 flex flex-col items-center justify-center rounded-xl border-2 border-dashed border-neutral-200 py-12 text-center">
            ...
            {recentRecordings.map((r) => (
              <li key={r.id}>
                <Link
                  ...
                  className="flex items-center justify-between rounded-lg border border-neutral-200 bg-white px-4 py-3 hover:bg-neutral-50 transition-colors"
                >
